...
const STATIC_TRANSLATIONS: Record<string, Record<string, string>> = {
    ...
    // Header
    "Facilitator Only": { "ta": "உதவியாளர் மட்டும்", "hi": "केवल सहायक" },
    "Active Session": { "ta": "செயலில் அமர்வு", "hi": "सक्रिय सत्र" },
    "No Active Session": { "ta": "செயலில் அமர்வு இல்லை", "hi": "कोई सक्रिय सत्र नहीं" },
    "Sign Out": { "ta": "வெளியேறு", "hi": "साइन आउट" },
    "min": { "ta": "நிமிடம்", "hi": "मिनट" },

    // Session Banner
    "Active Session:": { "ta": "செயலில் அமர்வு:", "hi": "सक्रिय सत्र:" },
    "Patient ID:": { "ta": "நோயாளி அடையாளம்:", "hi": "मरीज आईडी:" },
    "min remaining": { "ta": "நிமிடம் மீதமுள்ளது", "hi": "मिनट शेष" },
    "End Session": { "ta": "அமர்வை முடி", "hi": "सत्र समाप्त करें" },

    // Role Disclaimer
    "This is an Assisted Session.": { "ta": "இது ஒரு உதவி அமர்வு.", "hi": "यह एक सहायता सत्र है।" },
    "The patient must be present. You are a facilitator only — no medical decisions, no patient data access outside session.": { "ta": "நோயாளி இருக்க வேண்டும். நீங்கள் ஒரு உதவியாளர் மட்டுமே — மருத்துவ முடிவுகள் இல்லை, அமர்வுக்கு வெளியே நோயாளி தரவு அணுகல் இல்லை.", "hi": "मरीज का उपस्थित होना आवश्यक है। आप केवल एक सहायक हैं — कोई चिकित्सा निर्णय नहीं, सत्र के बाहर मरीज डेटा तक पहुंच नहीं।" },

    // Dashboard
    "Allowed Actions": { "ta": "அனுமதிக்கப்பட்ட செயல்கள்", "hi": "अनुमत कार्य" },
    "Patient must be present for all actions": { "ta": "அனைத்து செயல்களுக்கும் நோயாளி இருக்க வேண்டும்", "hi": "सभी कार्यों के लिए मरीज का उपस्थित होना आवश्यक है" },
    "Assisted Symptom Logging": { "ta": "உதவி அறிகுறி பதிவு", "hi": "सहायता प्राप्त लक्षण लॉगिंग" },
    "Record symptoms as patient describes them": { "ta": "நோயாளி விவரிக்கும்படி அறிகுறிகளை பதிவு செய்யவும்", "hi": "मरीज के बताए अनुसार लक्षण दर्ज करें" },
    "Voice-first • Multi-language": { "ta": "குரல்-முதல் • பல மொழி", "hi": "वॉयस-फर्स्ट • बहुभाषी" },
    "Document Upload": { "ta": "ஆவண பதிவேற்றம்", "hi": "दस्तावेज़ अपलोड" },
    "Upload medical reports and prescriptions": { "ta": "மருத்துவ அறிக்கைகள் மற்றும் மருந்து சீட்டுகளை பதிவேற்றவும்", "hi": "चिकित्सा रिपोर्ट और नुस्खे अपलोड करें" },
    "Camera • File upload": { "ta": "கேமரா • கோப்பு பதிவேற்றம்", "hi": "कैमरा • फ़ाइल अपलोड" },
    "Consent Explanation": { "ta": "சம்மத விளக்கம்", "hi": "सहमति स्पष्टीकरण" },
    "Explain consent and help patient confirm": { "ta": "சம்மதத்தை விளக்கி நோயாளி உறுதிப்படுத்த உதவுங்கள்", "hi": "सहमति समझाएं और मरीज को पुष्टि करने में मदद करें" },
    "Read-aloud • Patient confirms": { "ta": "வாசிப்பு • நோயாளி உறுதிப்படுத்துகிறார்", "hi": "पढ़कर सुनाएं • मरीज पुष्टि करता है" },
    "Initiate Consultation": { "ta": "ஆலோசனையைத் தொடங்கு", "hi": "परामर्श शुरू करें" },
    "Start audio or video call with doctor": { "ta": "மருத்துவருடன் ஆடியோ அல்லது வீடியோ அழைப்பைத் தொடங்கவும்", "hi": "डॉक्टर के साथ ऑडियो या वीडियो कॉल शुरू करें" },
    "Audio • Video options": { "ta": "ஆடியோ • வீடியோ விருப்பங்கள்", "hi": "ऑडियो • वीडियो विकल्प" },
    "Start a session to enable actions": { "ta": "செயல்களை இயக்க ஒரு அமர்வைத் தொடங்கவும்", "hi": "कार्य सक्षम करने के लिए एक सत्र शुरू करें" },

    // Restrictions & Rules Panels
    "🔒 You CANNOT Do These": { "ta": "🔒 இவற்றை நீங்கள் செய்ய முடியாது", "hi": "🔒 आप ये नहीं कर सकते" },
    "View AI intake summaries": { "ta": "AI தகவல் சுருக்கங்களைக் காண்", "hi": "AI सेवन सारांश देखें" },
    "View triage priority": { "ta": "முன்னுரிமை வரிசையைக் காண்", "hi": "ट्राइएज प्राथमिकता देखें" },
    "View doctor notes": { "ta": "மருத்துவர் குறிப்புகளைக் காண்", "hi": "डॉक्टर नोट्स देखें" },
    "View prescriptions": { "ta": "மருந்து சீட்டுகளைக் காண்", "hi": "नुस्खे देखें" },
    "Access patient data after session": { "ta": "அமர்வுக்குப் பிறகு நோயாளி தரவை அணுகவும்", "hi": "सत्र के बाद मरीज डेटा एक्सेस करें" },
    "Provide medical advice": { "ta": "மருத்துவ ஆலோசனை வழங்குதல்", "hi": "चिकित्सा सलाह देना" },
    "These restrictions protect patient privacy and ensure clinical decisions remain with qualified doctors.": { "ta": "இந்த கட்டுப்பாடுகள் நோயாளி தனியுரிமையைப் பாதுகாக்கின்றன மற்றும் மருத்துவ முடிவுகள் தகுதியான மருத்துவர்களிடம் இருப்பதை உறுதி செய்கின்றன.", "hi": "ये प्रतिबंध मरीज की गोपनीयता की रक्षा करते हैं और सुनिश्चित करते हैं कि क्लीनिकल निर्णय योग्य डॉक्टरों के पास रहें।" },
    "📋 Session Rules": { "ta": "📋 அமர்வு விதிகள்", "hi": "📋 सत्र नियम" },
    "Sessions are time-limited (30 min)": { "ta": "அமர்வுகள் நேர வரையறுக்கப்பட்டவை (30 நிமிடம்)", "hi": "सत्र समय-सीमित हैं (30 मिनट)" },
    "Patient presence is mandatory": { "ta": "நோயாளி இருப்பு கட்டாயம்", "hi": "मरीज की उपस्थिति अनिवार्य है" },
    "All actions are logged": { "ta": "அனைத்து செயல்களும் பதிவு செய்யப்படுகின்றன", "hi": "सभी कार्य लॉग किए जाते हैं" },
    "All uploads are patient-tagged": { "ta": "அனைத்து பதிவேற்றங்களும் நோயாளி குறியிடப்பட்டவை", "hi": "सभी अपलोड मरीज-टैग किए गए हैं" },
    "Access revoked when session ends": { "ta": "அமர்வு முடியும்போது அணுகல் ரத்து செய்யப்படும்", "hi": "सत्र समाप्त होने पर एक्सेस रद्द" },

    // Symptoms Screen
    "← Back to Dashboard": { "ta": "← டாஷ்போர்டுக்கு திரும்பு", "hi": "← डैशबोर्ड पर वापस" },
    "You are recording what the patient says. Do not interpret or diagnose.": { "ta": "நீங்கள் நோயாளி சொல்வதை பதிவு செய்கிறீர்கள். விளக்கம் அல்லது நோயறிதல் செய்யாதீர்கள்.", "hi": "आप मरीज जो कहता है उसे रिकॉर्ड कर रहे हैं। व्याख्या या निदान न करें।" },
    "Patient's Language:": { "ta": "நோயாளியின் மொழி:", "hi": "मरीज की भाषा:" },
    "Tap to use voice input": { "ta": "குரல் உள்ளீடு பயன்படுத்த தட்டவும்", "hi": "वॉयस इनपुट के लिए टैप करें" },
    "Or type symptoms as patient describes:": { "ta": "அல்லது நோயாளி விவரிக்கும்படி அறிகுறிகளை தட்டச்சு செய்யவும்:", "hi": "या मरीज के बताए अनुसार लक्षण टाइप करें:" },
    "Save to Patient Logbook": { "ta": "நோயாளி பதிவேட்டில் சேமி", "hi": "मरीज लॉगबुक में सहेजें" },
    "Symptoms are saved directly to patient's logbook. You will NOT see previous entries.": { "ta": "அறிகுறிகள் நேரடியாக நோயாளியின் பதிவேட்டில் சேமிக்கப்படுகின்றன. முந்தைய பதிவுகளை நீங்கள் பார்க்க மாட்டீர்கள்.", "hi": "लक्षण सीधे मरीज की लॉगबुक में सहेजे जाते हैं। आप पिछली प्रविष्टियां नहीं देखेंगे।" },

    // Upload Screen
    "Upload documents for the patient. You will NOT see document contents or history.": { "ta": "நோயாளிக்கான ஆவணங்களை பதிவேற்றவும். ஆவண உள்ளடக்கங்கள் அல்லது வரலாற்றை நீங்கள் பார்க்க மாட்டீர்கள்.", "hi": "मरीज के लिए दस्तावेज़ अपलोड करें। आप दस्तावेज़ सामग्री या इतिहास नहीं देखेंगे।" },
    "Camera": { "ta": "கேமரா", "hi": "कैमरा" },
    "Choose File": { "ta": "கோப்பைத் தேர்வு செய்", "hi": "फ़ाइल चुनें" },
    "Supported: Images, PDF documents": { "ta": "ஆதரிக்கப்படுவது: படங்கள், PDF ஆவணங்கள்", "hi": "समर्थित: चित्र, PDF दस्तावेज़" },
    "Uploading...": { "ta": "பதிவேற்றுகிறது...", "hi": "अपलोड हो रहा है..." },
    "Document uploaded successfully": { "ta": "ஆவணம் வெற்றிகரமாக பதிவேற்றப்பட்டது", "hi": "दस्तावेज़ सफलतापूर्वक अपलोड हो गया" },
    "Upload Another": { "ta": "மற்றொன்றை பதிவேற்று", "hi": "और अपलोड करें" },
    "Documents are tagged to patient and require their consent before doctor can view.": { "ta": "ஆவணங்கள் நோயாளிக்கு குறியிடப்படுகின்றன மற்றும் மருத்துவர் பார்ப்பதற்கு முன் அவரது சம்மதம் தேவை.", "hi": "दस्तावेज़ मरीज से टैग किए जाते हैं और डॉक्टर देखने से पहले उनकी सहमति आवश्यक है।" },

    // Consent Screen
    "Your role: Explain consent clearly. The PATIENT must confirm, not you.": { "ta": "உங்கள் பங்கு: சம்மதத்தை தெளிவாக விளக்குங்கள். நோயாளி உறுதிப்படுத்த வேண்டும், நீங்கள் அல்ல.", "hi": "आपकी भूमिका: सहमति स्पष्ट रूप से समझाएं। मरीज को पुष्टि करनी होगी, आपको नहीं।" },
    "Read Aloud to Patient:": { "ta": "நோயாளிக்கு வாசித்துக் காட்டுங்கள்:", "hi": "मरीज को पढ़कर सुनाएं:" },
    "consent_para_1": { "ta": "\"உங்கள் உடல்நலத் தகவல்கள் மருத்துவரிடம் பகிரப்படும், அவர் உங்கள் நிலையைப் புரிந்துகொண்டு சிகிச்சை அளிக்க உதவும். இதில் நீங்கள் விவரித்த அறிகுறிகள் மற்றும் நீங்கள் பதிவேற்றிய ஆவணங்கள் அடங்கும்.", "hi": "\"आपकी स्वास्थ्य जानकारी डॉक्टर के साथ साझा की जाएगी ताकि वे आपकी स्थिति को समझ सकें और उपचार प्रदान कर सकें। इसमें आपके द्वारा बताए गए लक्षण और अपलोड किए गए दस्तावेज़ शामिल हैं।" },
    "consent_para_2": { "ta": "நீங்கள் எந்த நேரத்திலும் உங்கள் சம்மதத்தை திரும்பப் பெறலாம். ஆலோசனை முடிந்த பிறகு உங்கள் அனுமதியின்றி மருத்துவர் மற்றும் சுகாதார பணியாளர் உங்கள் தகவல்களை அணுக முடியாது.", "hi": "आप कभी भी अपनी सहमति वापस ले सकते हैं। परामर्श समाप्त होने के बाद डॉक्टर और स्वास्थ्य कार्यकर्ता आपकी अनुमति के बिना आपकी जानकारी तक नहीं पहुंच सकते।" },
    "consent_para_3": { "ta": "நீங்கள் புரிந்துகொண்டு உங்கள் உடல்நலத் தகவல்களை பகிர ஒப்புக்கொள்கிறீர்களா?\"", "hi": "क्या आप समझते हैं और अपनी स्वास्थ्य जानकारी साझा करने के लिए सहमत हैं?\"" },
    "🔊 Read Aloud": { "ta": "🔊 வாசி", "hi": "🔊 पढ़कर सुनाएं" },
    "⏹ Stop Reading": { "ta": "⏹ வாசிப்பை நிறுத்து", "hi": "⏹ पढ़ना बंद करें" },
    "I have explained consent to the patient": { "ta": "நான் நோயாளிக்கு சம்மதத்தை விளக்கினேன்", "hi": "मैंने मरीज को सहमति समझा दी है" },
    "PATIENT has confirmed they understand and consent": { "ta": "நோயாளி புரிந்துகொண்டு சம்மதித்ததை உறுதிப்படுத்தினார்", "hi": "मरीज ने पुष्टि की कि वे समझते हैं और सहमत हैं" },
    "Record Consent & Proceed to Consultation": { "ta": "சம்மதத்தை பதிவு செய்து ஆலோசனைக்கு செல்", "hi": "सहमति दर्ज करें और परामर्श के लिए आगे बढ़ें" },
    "Patient can revoke consent at any time through their own app.": { "ta": "நோயாளி எந்த நேரத்திலும் தங்கள் சொந்த ஆப் மூலம் சம்மதத்தை ரத்து செய்யலாம்.", "hi": "मरीज किसी भी समय अपने ऐप के माध्यम से सहमति रद्द कर सकता है।" },

    // Voice Consent Recording
    "🎤 Record Patient Consent": { "ta": "🎤 நோயாளி சம்மதத்தை பதிவு செய்", "hi": "🎤 मरीज की सहमति रिकॉर्ड करें" },
    "⏹ Stop Recording": { "ta": "⏹ பதிவை நிறுத்து", "hi": "⏹ रिकॉर्डिंग बंद करें" },
    "Patient voice consent recorded": { "ta": "நோயாளி குரல் சம்மதம் பதிவு செய்யப்பட்டது", "hi": "मरीज की वॉयस सहमति रिकॉर्ड की गई" },
    "🔄 Re-record": { "ta": "🔄 மீண்டும் பதிவு செய்", "hi": "🔄 फिर से रिकॉर्ड करें" },
    "✅ Voice consent attached to session": { "ta": "✅ குரல் சம்மதம் அமர்வுடன் இணைக்கப்பட்டது", "hi": "✅ वॉयस सहमति सत्र से जुड़ी" },
    "Optional: Patient can give verbal consent via recording": { "ta": "விரும்பினால்: நோயாளி பதிவு மூலம் வாய்மொழி சம்மதம் அளிக்கலாம்", "hi": "वैकल्पिक: मरीज रिकॉर्डिंग के माध्यम से मौखिक सहमति दे सकता है" },

    // Consult Screen
    "You initiate the call. Leave if patient requests privacy during consultation.": { "ta": "நீங்கள் அழைப்பைத் தொடங்குங்கள். ஆலோசனையின் போது நோயாளி தனியுரிமை கோரினால் வெளியேறுங்கள்.", "hi": "आप कॉल शुरू करें। परामर्श के दौरान मरीज गोपनीयता चाहे तो बाहर जाएं।" },
    "Start Consultation": { "ta": "ஆலோசனையைத் தொடங்கு", "hi": "परामर्श शुरू करें" },
    "Waiting for Doctor...": { "ta": "மருத்துவருக்காக காத்திருக்கிறது...", "hi": "डॉक्टर की प्रतीक्षा..." },
    "The patient is in queue. A doctor will join shortly.": { "ta": "நோயாளி வரிசையில் இருக்கிறார். ஒரு மருத்துவர் விரைவில் இணைவார்.", "hi": "मरीज कतार में है। एक डॉक्टर जल्द ही जुड़ेंगे।" },
    "Do not speak on behalf of doctor or interpret their advice.": { "ta": "மருத்துவர் சார்பாக பேசாதீர்கள் அல்லது அவர்களின் ஆலோசனையை விளக்காதீர்கள்.", "hi": "डॉक्टर की ओर से न बोलें या उनकी सलाह की व्याख्या न करें।" },

    // Start Session Modal
    "Start Assisted Session": { "ta": "உதவி அமர்வைத் தொடங்கு", "hi": "सहायता सत्र शुरू करें" },
    "Patient is physically present with me now": { "ta": "நோயாளி இப்போது என்னுடன் நேரில் இருக்கிறார்", "hi": "मरीज अभी मेरे साथ शारीरिक रूप से उपस्थित है" },
    "I understand I am a facilitator only, not a medical provider": { "ta": "நான் ஒரு உதவியாளர் மட்டுமே, மருத்துவ வழங்குநர் அல்ல என்று புரிந்துகொள்கிறேன்", "hi": "मैं समझता/समझती हूं कि मैं केवल एक सहायक हूं, चिकित्सा प्रदाता नहीं" },
    "Patient ID (if registered)": { "ta": "நோயாளி அடையாளம் (பதிவு செய்திருந்தால்)", "hi": "मरीज आईडी (यदि पंजीकृत)" },
    "Enter patient ID or phone": { "ta": "நோயாளி அடையாளம் அல்லது தொலைபேசி உள்ளிடவும்", "hi": "मरीज आईडी या फ़ोन दर्ज करें" },
    "or": { "ta": "அல்லது", "hi": "या" },
    "Patient Name (for new/temp patient)": { "ta": "நோயாளி பெயர் (புதிய/தற்காலிக நோயாளிக்கு)", "hi": "मरीज का नाम (नए/अस्थायी मरीज के लिए)" },
    "Enter patient name": { "ta": "நோயாளி பெயரை உள்ளிடவும்", "hi": "मरीज का नाम दर्ज करें" },
    "Start Session": { "ta": "அமர்வைத் தொடங்கு", "hi": "सत्र शुरू करें" },

    // End Session Modal
    "End Session?": { "ta": "அமர்வை முடிக்கவா?", "hi": "सत्र समाप्त करें?" },
    "This will immediately revoke all access to patient actions. Any unsaved work will be lost.": { "ta": "இது நோயாளி செயல்களுக்கான அனைத்து அணுகலையும் உடனடியாக ரத்து செய்யும். சேமிக்கப்படாத வேலைகள் இழக்கப்படும்.", "hi": "यह मरीज के कार्यों तक सभी एक्सेस तुरंत रद्द कर देगा। सहेजा न गया काम खो जाएगा।" },
    "Continue Session": { "ta": "அமர்வைத் தொடரவும்", "hi": "सत्र जारी रखें" },

    // Footer
    "Health Worker Portal • Facilitator Access Only • All actions are logged": { "ta": "சுகாதார பணியாளர் போர்டல் • உதவியாளர் அணுகல் மட்டுமே • அனைத்து செயல்களும் பதிவு செய்யப்படுகின்றன", "hi": "स्वास्थ्य कार्यकर्ता पोर्टल • केवल सहायक एक्सेस • सभी कार्य लॉग किए जाते हैं" },

    // Status Messages
    "Session expired. All access has been revoked.": { "ta": "அமர்வு காலாவதியானது. அனைத்து அணுகலும் ரத்து செய்யப்பட்டது.", "hi": "सत्र समाप्त हो गया। सभी एक्सेस रद्द कर दी गई है।" },
    "Please confirm all requirements before starting.": { "ta": "தொடங்குவதற்கு முன் அனைத்து தேவைகளையும் உறுதிப்படுத்தவும்.", "hi": "शुरू करने से पहले सभी आवश्यकताओं की पुष्टि करें।" },
    "Please enter Patient ID or Name.": { "ta": "நோயாளி அடையாளம் அல்லது பெயரை உள்ளிடவும்.", "hi": "कृपया मरीज आईडी या नाम दर्ज करें।" },
    "Session started. Patient must remain present for all actions.": { "ta": "அமர்வு தொடங்கியது. அனைத்து செயல்களுக்கும் நோயாளி இருக்க வேண்டும்.", "hi": "सत्र शुरू हो गया। सभी कार्यों के लिए मरीज का उपस्थित रहना आवश्यक है।" },
    "Symptoms saved to patient logbook.": { "ta": "அறிகுறிகள் நோயாளி பதிவேட்டில் சேமிக்கப்பட்டன.", "hi": "लक्षण मरीज लॉगबुक में सहेजे गए।" },
    "Document uploaded successfully.": { "ta": "ஆவணம் வெற்றிகரமாக பதிவேற்றப்பட்டது.", "hi": "दस्तावेज़ सफलतापूर्वक अपलोड हो गया।" },
    "Patient consent recorded. Proceeding to consultation...": { "ta": "நோயாளி சம்மதம் பதிவு செய்யப்பட்டது. ஆலோசனைக்கு செல்கிறது...", "hi": "मरीज की सहमति दर्ज की गई। परामर्श के लिए आगे बढ़ रहा है..." },
    "Session ended. All access has been revoked.": { "ta": "அமர்வு முடிந்தது. அனைத்து அணுகலும் ரத்து செய்யப்பட்டது.", "hi": "सत्र समाप्त हो गया। सभी एक्सेस रद्द कर दी गई है।" },
    "consultation initiated. Waiting for doctor...": { "ta": "ஆலோசனை தொடங்கப்பட்டது. மருத்துவருக்காக காத்திருக்கிறது...", "hi": "परामर्श शुरू किया गया। डॉक्टर की प्रतीक्षा..." },
    "Loading Health Worker Portal...": { "ta": "சுகாதார பணியாளர் போர்டல் ஏற்றுகிறது...", "hi": "स्वास्थ्य कार्यकर्ता पोर्टल लोड हो रहा है..." },
    "Video": { "ta": "வீடியோ", "hi": "वीडियो" },
    "Audio": { "ta": "ஆடியோ", "hi": "ऑडियो" },
};
